...
//    }
    ...
    public String uploadOneFileHandlerPOST(Model model, @ModelAttribute("myUploadForm") MyUploadForm myUploadForm) {
    ...
    public String uploadMultiFileHandlerPOST(Model model, @ModelAttribute("myUploadForm") MyUploadForm myUploadForm) {
        System.out.println(myUploadForm);
        return this.doUpload(model, myUploadForm);
    }
    private String doUpload(Model model, MyUploadForm myUploadForm) {
        ...
        for (CommonsMultipartFile fileData : fileDatas) {
            ...
            if (name != null && name.length() > 0) {
                File serverFile = new File("D:\\JAVA\\[BC-JAVA-WBDS] Web Back-end Development with Spring MVC 2.0\\module-4\\4.Data Binding & Form\\UploadFile\\upload" + name);
